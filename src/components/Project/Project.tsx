        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/Peggymailula/React-graphs.git" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a>
              </div>
            </header>
            <div className="body">
              <h3>Transport Intelligence Graphs</h3>
              <p>
                Developed a web page that visualizes transport data using React and CanvasJs, providing interactive and insightful graphs for data analysis.
              </p>
              <img src={graphs} className="project-screenshot" alt="Transport Intelligence Graphs" />
            </div>
            <footer>
              <ul className="tech-list">
                <li>React</li>
